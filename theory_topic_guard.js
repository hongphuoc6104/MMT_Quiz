...
(function(){
  ...
  function debugMatch(question,limit=10){return rankedMatches(question,limit).map(x=>({id:x.concept.id,title:x.concept.title,score:x.score,questionHits:x.qHits,optionHits:x.oHits}));}
